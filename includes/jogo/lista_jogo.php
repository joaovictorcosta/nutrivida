...
<div class="container-fluid">
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading"><i class="fa fa-soccer-ball-o"></i> JOGOS</div>
            <br />
            <div id="filtros">
                ...
                <div id="info_legendas">
                    ...
                    <span class="label label-danger"><i class="glyphicon glyphicon-check"></i> - Finalizar</span>
                                ...
                                <td style="width: 80px">
                                    <center>
                                        <a href="" class="btn btn-danger" data-toggle="modal" 
                                           title="Finalizar Jogo" data-target="#modal_finalizar_partida_<?php echo $jogos['id']; ?>" >
